...
class Greet(commands.Cog):
    ...
    @boost.command(
        name="variables",
        help="config",
        description="return the variables for the boost message",
    )
    async def boost_variables(self, ctx: commands.Context):
        await ctx.invoke(self.bot.get_command("variables"))

    @boost.command(
        name="config", help="config", description="returns stats of the boost message"
    )
    ...
    @boost.command(
        name="delete",
        help="config",
        description="delete the boost module",
        brief="manage guild",
    )
    @Perms.get_perms("manage_guild")
    ...
    @leave.command(
        name="delete",
        help="config",
        description="delete the leave module",
        brief="manage guild",
    )
    @Perms.get_perms("manage_guild")
    ...
    @welcome.command(
        name="delete",
        help="config",
        description="delete the welcome module",
        brief="manage guild",
    )
    @Perms.get_perms("manage_guild")
    ...
    @welcome.command(
        name="test",
        help="config",
        description="test welcome module",
        brief="manage guild",
    )
    @Perms.get_perms("manage_guild")
