...
from get.checks import Joint, Perms
    ...
    async def yes(self, interaction: discord.Interaction, button: discord.ui.Button):
        if interaction.user == self.ctx.author:
            ...
            embe = discord.Embed(
                ...
                description=f":heart: **{self.ctx.author}** succesfully married with **{self.member}**",
            )
...
class roleplay(commands.Cog):
    ...
    @commands.hybrid_command(
        description="marry an user", help="roleplay", usage="[user]"
    )
