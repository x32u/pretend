...
unlockemoji = "<:1226148238411694120:1260756791030054912>"
lockemoji = "<:1226148245567176765:1260756781802717184>"
plusemoji = "<:1226148222578200666:1260756789125972060>"
minusemoji = "<:1226148224264568892:1260756780116480021>"
channelemoji = "<:1226148225971523627:1260756787146264647>"
unghostemoji = "<:1226148230488920075:1260756776647786517>"
ghostemoji = "<:1226148228593094676:1260756774978453605>"
claimemoji = "<:1226148232464437259:1260756783547289680>"
hammeremoji = "<:1226148235127816232:1260756778417913949>"
manemoji = "<:1226148220997210203:1260756785225007144>"
    ...
    async def reveal(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if check is not None:
            ...
            if (
                ...
                return await interaction.client.ext.send_warning(
                    interaction,
                    "This server wasn't **upgraded** to **premium**. Join [here](https://discord.gg/pretend) to upgrade!",
                    ephemeral=True,
                )
            che = await interaction.client.db.fetchrow(
                "SELECT * FROM vcs WHERE voice = $1 AND user_id = $2",
    ...
    async def activity(
        ...
        if check is not None:
            ...
            if (
                ...
                return await interaction.client.ext.send_warning(
                    interaction,
                    "This server wasn't **upgraded** to **premium**. Join [here](https://discord.gg/RXryRTHE7V) to upgrade!",
                    ephemeral=True,
                )
...
class voicemaster(commands.Cog):
    ...
    def create_interface(self, ctx: commands.Context) -> discord.Embed:
        ...
        em.add_field(
            name="Manage",
            value=f"{lockemoji} [`lock`](https://discord.gg/RXryRTHE7V) the voice channel\n{unlockemoji} [`unlock`](https://discord.gg/RXryRTHE7V) the voice channel\n{ghostemoji} [`hide`](https://discord.gg/RXryRTHE7V) the voice channel\n{unghostemoji} [`reveal`](https://discord.gg/RXryRTHE7V) the voice channel\n{channelemoji} [`rename`](https://discord.gg/RXryRTHE7V) the voice channel",
        )
        em.add_field(
            name="Misc",
            value=f"{plusemoji} [`increase`](https://discord.gg/RXryRTHE7V) the user limit\n{minusemoji} [`decrease`](https://discord.gg/RXryRTHE7V) the user limit\n{claimemoji} [`claim`](https://discord.gg/RXryRTHE7V) the voice channel\n{manemoji} [`info`](https://discord.gg/RXryRTHE7V) of the channel\n{hammeremoji} [`moderate`](https://discord.gg/RXryRTHE7V) the voice channel",
        )
        return em
    ...
    @voice.command(
        description="lock the voice channel", help="config", brief="vc owner"
    )
    @check_vc_owner()
    ...
    @voice.command(
        description="unlock the voice channel", help="config", brief="vc owner"
    )
    @check_vc_owner()
    ...
    @voice.command(
        description="hide the voice channel", help="config", brief="vc owner"
    )
    @check_vc_owner()
    ...
    @voice.command(
        description="reveal the voice channel", help="config", brief="vc owner"
    )
    @check_vc_owner()
    ...
    @commands.command(
        description="sends an updated interface of voicemaster",
        help="config",
        brief="administrator",
    )
    ...
    @voicemaster.command(
        description="sets voicemaster module for your server",
        help="config",
        brief="administrator",
    )
    @Perms.get_perms("administrator")
