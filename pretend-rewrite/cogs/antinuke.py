...
from get.utils import Whitelist
...
class AntiNuke(commands.Cog):
    ...
    async def sendlogs(self, action: str, member: discord.Member, punishment: str):
        ...
        embed = discord.Embed(
            ...
            description="Was pretend fast? If yes, please give us a review in https://discord.gg/pretendbot",
        )
    ...
    @antinuke.group(
        name="admin", invoke_without_command=True, description="manage antinuke admins"
    )
    ...
    @an_channels.command(
        name="enable",
        aliases=["e"],
        description="enable channel delete protection",
        usage="[punishment]",
        brief="antinuke admin",
        help="antinuke",
    )
    ...
    @an_channels.command(
        name="disable",
        aliases=["dis"],
        description="disable channel delete protection",
        help="antinuke",
        brief="antinuke admin",
    )
    @Perms.check_whitelist("antinuke")
    ...
    async def an_channels_threshold(self, ctx: commands.Context, number: int):
        ...
        return await ctx.send_success(
            f"Antinuke channel delete threshold changed to **{number}** kicks per **60** seconds"
        )

    @antinuke.group(
        name="kick",
        invoke_without_command=True,
        description="prevent members from mass kicking other members",
    )
    ...
    @antinuke.group(
        name="ban",
        invoke_without_command=True,
        description="prevent members from mass banning other members",
    )
    ...
    @antinuke.group(
        ...
        aliases=["antibot"],
        invoke_without_command=True,
        description="prevent bots from joining your server",
    )
    ...
    @botadd.command(
        name="whitelisted", help="antinuke", description="returns antinuke admins"
    )
    @is_antinuke()
