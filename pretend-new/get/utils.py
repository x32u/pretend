...
class NoStaff(commands.Converter): 
  async def convert(self, ctx: commands.Context, argument): 
    ...
    if member.id == ctx.guild.me.id: raise commands.BadArgument("leave me alone <a:AImAngry:1139210632139378768>") 
...
class PaginatorView(discord.ui.View): 
    ...
    @discord.ui.button(emoji="<:left:1018156480991612999>", style=discord.ButtonStyle.primary)
    ...
    @discord.ui.button(emoji="<:right:1018156484170883154>", style=discord.ButtonStyle.primary)
...
class StartUp:
 ...
 async def startup(bot):
    await bot.loop.create_task(bot.create_db_pool())
...
async def create_db_pool(self: commands.AutoShardedBot): 
