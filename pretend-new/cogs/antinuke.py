...
class AntiNuke(commands.Cog):
   ...
   async def sendlogs(self, action: str, member: discord.Member, punishment: str): 
    ...
    embed = discord.Embed(color=self.bot.color, title=f"{member} punished", description="Was pretend fast? If yes, please give us a review in https://discord.gg/pretendbot")
