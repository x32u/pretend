    ...
    async def edit(self, ctx: commands.Context): 
        ...
        if role is None: options = [
          ...
          discord.SelectOption(
            ...
            emoji="<:flauntchannel:1235995726115508224>"
          ),
          discord.SelectOption(
            label="color",
            description="change the color of your role",
            emoji="<:1226148235127816232:1260756778417913949>"
          ),
          discord.SelectOption(
            label="icon",
            description="change the role icon",
            emoji="<:1226148220997210203:1260756785225007144>"
          ),
          discord.SelectOption(
            label="hoist", 
            description="make your role hoisted...or not",
            emoji="<:1226148230488920075:1260756776647786517>"
          ),
          discord.SelectOption( 
            label="delete",
            description="delete your booster role",
            emoji="<:1082294834909417592:1259111353503715389>"
          ),
            discord.SelectOption(
            label="cancel",
            description="cancel the booster role edit",
