...
class Auth(commands.Cog): 
    ...
    @commands.command()
    @is_owner()
    async def authserver(self, ctx: commands.Context, guildid: int=None, buyer: Union[discord.Member, discord.User]=None, offer: str=None): 
    ...
    @commands.command()
    @is_owner()
    async def transfers(self, ctx: commands.Context, oldserver: int=None, newserver: int=None):  
